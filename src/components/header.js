  ...
  render() { 
    return (
      <HeaderWrap>
        ...
        <CTAWrapper>
          <Button href='mailto: digregoj@hotmail.com'>I'm Interested</Button>
          <ScrollLink href='#portfolio'>
            <ScrollDownArrow xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-arrow-down-circle" viewBox="0 0 16 16" focusable="false">
